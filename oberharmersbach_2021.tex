...
\setbeamersize{text margin left = 8em, text margin right = 8em}
...
\begin{frame}
	\begin{tikzpicture}
		...
		\node at (4,-4.2) {$\Z((T)) \to \R$};
		\node at (4,-5.0) {Condensed mathematics};
		\node at (4,-5.8) {Categorical reduction steps};
	\end{tikzpicture}
\end{frame}
